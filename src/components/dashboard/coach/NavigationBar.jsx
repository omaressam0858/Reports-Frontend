        ...
        <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            <div>
                ...
                <div className="mt-8 text-center">
                    ...
                    <span className="hidden text-gray-400 lg:block">Coach</span>
                </div>

                <ul className="space-y-2 tracking-wide mt-8">
                    <li>
                        <Link href="/coach" aria-label="dashboard" className={currentPath == "/coach" ? "relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400 " : "px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group"}>
                    ...
                    <li>
                        <Link href="/coach/reports" className={currentPath == "/coach/reports" ? "relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400 " : "px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group"}>
